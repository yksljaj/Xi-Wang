...
- (void)layoutSubviews
{
    ...
    // 承载视频View
    self.playView.frame = CGRectMake(0, 100, width, height);
...
//    CGFloat backY = (topH - backH)/2;
    ...
    CGFloat playH = 70;
    CGFloat playX = 15;
    CGFloat playY = viewHeight*4/7-10;
    self.playBtn.frame = CGRectMake(playX, playY, playW, playH);
    // 滑动条
    CGFloat sliderX = CGRectGetWidth(self.playBtn.frame) + 25;
    CGFloat sliderH = 30;
